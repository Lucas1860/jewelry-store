...
function openn(num){
    if (num === 1)
        window.open("file:///C:/Users/avaki/OneDrive/%D0%A0%D0%B0%D0%B1%D0%BE%D1%87%D0%B8%D0%B9%20%D1%81%D1%82%D0%BE%D0%BB/%D0%BF%D1%80%D0%B0%D0%BA%D1%82%D0%B8%D0%BA%D0%B8%20%D1%81%D0%B0%D0%B9%D1%82%D1%8B/page1.html", "_blank");
    else if (num === 2)
...
function initApp(){
    products.forEach((value, key) =>{
        ...
        newDiv.innerHTML = `
            <img onclick=openn(${value.id}) src="C:/Users/avaki/OneDrive/Рабочий стол/ювелирка/Украшения/${value.image}">
...
function reloadCard(){
    ...
    listCards.forEach((value, key)=>{
        ...
        if(value != null){
            ...
            newDiv.innerHTML = `
                <div><img src="C:/Users/avaki/OneDrive/Рабочий стол/ювелирка/Украшения/${value.image}"/></div>
                <div>${value.name}</div>
